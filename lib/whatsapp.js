...
export const WA_SOLARFI_CONSULT =
  'Hi AY Solar Energy, I want a free consultation for SolarFi — reserve capacity / bill savings (Jaipur or Tonk).';

// Backward-compatible export for existing imports.
export const WA_DIGITAL_SOLAR_CONSULT = WA_SOLARFI_CONSULT;
