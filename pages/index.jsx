        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '30px' }}>
            <div style={{ padding: '30px', backgroundColor: '#f9f9f9', borderRadius: '8px' }}>
              ...
              <div style={{ fontWeight: '600', color: '#0057B8' }}>Usha Bal</div>
            ...
            <div style={{ padding: '30px', backgroundColor: '#f9f9f9', borderRadius: '8px' }}>
              ...
              <div style={{ fontWeight: '600', color: '#0057B8' }}>Sunil Kumar</div>
            ...
            <div style={{ padding: '30px', backgroundColor: '#f9f9f9', borderRadius: '8px' }}>
              ...
              <div style={{ fontWeight: '600', color: '#0057B8' }}>Makbool Khatun</div>
              <div style={{ fontSize: '0.9rem', color: '#666' }}>Jaipur, Rajasthan</div>
            </div>
          </div>
        </div>
