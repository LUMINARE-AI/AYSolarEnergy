...
const FAQ_ITEMS = [
  { q: 'How long does installation take?', a: 'Typically 2–3 days for residential systems' },
  { q: 'What is the warranty period?', a: '25 years for panels, 5 years for inverter' },
  { q: 'Do you provide financing options?', a: 'Yes, we offer EMI options through partner banks' },
  { q: 'Is there any maintenance required?', a: 'Minimal maintenance — free for first 5 years' },
];
  ...
  return (
    <>
      ...
      <div className={sp.root}>
        <Hero title="Contact Us" subtitle="Get your free solar consultation" pageHero />

        <section className={sp.section}>
          <div className={sp.wrapWide}>
            <div className={sp.contactGrid}>
              <div className={sp.contactInfoBlock}>
                <h3>Contact information</h3>
                <div className={sp.contactList}>
                  <div className={sp.contactRow}>
                    <span className={sp.contactIconBox} aria-hidden>
        ...
        <section className={sp.section}>
          <div className={sp.wrap}>
            ...
            <div className={sp.grid2}>
              {FAQ_ITEMS.map((item) => (
                <div key={item.q} className={sp.faqCard}>
                  <h4>{item.q}</h4>
                  <p>{item.a}</p>
                </div>
              ))}
